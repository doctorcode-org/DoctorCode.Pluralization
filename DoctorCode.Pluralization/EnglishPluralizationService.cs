...
namespace DoctorCode.Pluralization
{
    ...
    {
        public static PluralizationService Defualt { get; } = CreateService(new CultureInfo("en"));
        ...
        private readonly string[] _uninflectiveSuffixList = new string[]
        {
            "fish", "ois", "sheep", "deer", "pos", "itis", "ism"
        };

        private readonly string[] _uninflectiveWordList = new string[]
        {
        ...
        private readonly Dictionary<string, string> _irregularPluralsDictionary = new Dictionary<string, string>()
        {
        ...
        private readonly Dictionary<string, string> _assimilatedClassicalInflectionDictionary = new Dictionary<string, string>()
        {
        ...
        private readonly Dictionary<string, string> _oSuffixDictionary = new Dictionary<string, string>()
        {
        ...
        private readonly Dictionary<string, string> _classicalInflectionDictionary = new Dictionary<string, string>()
        {
        ...
        private readonly Dictionary<string, string> _wordsEndingWithSeDictionary = new Dictionary<string, string>()
        {
        ...
        private readonly Dictionary<string, string> _wordsEndingWithSisDictionary = new Dictionary<string, string>()
        {
        ...
        private readonly Dictionary<string, string> _wordsEndingWithSusDictionary = new Dictionary<string, string>()
        {
            {"consensus","consensuses"}, {"census", "censuses"}
        };

        private readonly Dictionary<string, string> _wordsEndingWithInxAnxYnxDictionary = new Dictionary<string, string>()
        {
            {"sphinx", "sphinxes"},
